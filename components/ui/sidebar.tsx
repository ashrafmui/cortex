...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 translate-x-px flex-col border-l border-sidebar-border px-2.5 py-1 group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
